...
class ScreenUtil {
  ...
  static void init({
    ...
    _instance._screenHeight = window.physicalSize.height;
    _instance._screenWidth = window.physicalSize.width;
  ...
  double get scaleHeight => (_screenHeight - _statusBarHeight - _bottomBarHeight) / uiSize.height;
